...
- Free API keys for: [Groq](https://console.groq.com), [Cerebras](https://cloud.cerebras.ai), [Google AI Studio](https://aistudio.google.com), [SambaNova](https://cloud.sambanova.ai)
...
Copy `frontend/.env.production` to `frontend/.env.local` for the Vite dev server:
...
Open your Supabase project → **SQL Editor** and run the files in order:

```
supabase/migrations/001_initial.sql
supabase/migrations/002_add_pace.sql
supabase/migrations/003_session_questions.sql
supabase/migrations/004_add_is_calibrated.sql
```
